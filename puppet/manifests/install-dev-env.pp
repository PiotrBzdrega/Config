...
node 'dev-box' {
	...
	exec { 'maven':
		command => "/usr/bin/wget -q -P /home/dev/Tools https://archive.apache.org/dist/maven/maven-3/${mavenVersion}/binaries/apache-maven-${mavenVersion}-bin.tar.gz && /bin/tar xzf /home/dev/Tools/apache-maven-${mavenVersion}-bin.tar.gz -C /home/dev/Tools && /bin/ln -s /home/dev/Tools/apache-maven-${mavenVersion}/bin/mvn /usr/bin/mvn",
		returns => [0, 4],
	}
